...
using("ggplot2","tidyverse","knitr","brms","sjPlot","gridExtra","future","ggpmisc")
plan(multicore)
...
set.seed(2020)
  ...
  fit.kfold=brms::kfold(fit[[i]], folds="stratified", save_fits = TRUE)
...
ggarrange(pp1, pp2,pp3, widths = c(3,1.5,1.5),nrow=1)
```
...
ggplot(data = dat, aes(x = x, y = y)) +
  ...
  geom_richtext(data = dat_lm, 
             ...
             vjust = 1.3, hjust = 2.6,inherit.aes = FALSE,fill = NA, label.color = NA) +
theme_bw() + mytheme
```
