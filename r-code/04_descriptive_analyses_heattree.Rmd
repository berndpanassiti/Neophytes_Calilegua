...
set.seed(2020) # This makes the plot appear the same each time it is run 
NeophytesTraitsTaxmap %>%
  heat_tree(
          node_label = taxon_names,
          node_size = n_obs,
          node_color = NeophytesTraitsTaxmap$data$diff_table$Nmean_diff_s, 
          node_color_range = c("#e5e5e5","#999999"),
                   node_color_trans = "linear",
